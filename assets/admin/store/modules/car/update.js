...
import {
  CAR_UPDATE_RESET,
  CAR_UPDATE_UPDATE_ERROR,
  CAR_UPDATE_UPDATE_LOADING,
  CAR_UPDATE_UPDATE_SUCCESS,
  CAR_UPDATE_RETRIEVE_ERROR,
  CAR_UPDATE_RETRIEVE_LOADING,
  CAR_UPDATE_RETRIEVE_SUCCESS,
  CAR_UPDATE_UPDATE_VIOLATIONS
} from './mutation-types';
...
function retrieveError(retrieveError) {
  return {type: CAR_UPDATE_RETRIEVE_ERROR, retrieveError};
}

function retrieveLoading(retrieveLoading) {
  return {type: CAR_UPDATE_RETRIEVE_LOADING, retrieveLoading};
}

function retrieveSuccess(retrieved) {
  return {type: CAR_UPDATE_RETRIEVE_SUCCESS, retrieved};
}

function updateError(updateError) {
  return {type: CAR_UPDATE_UPDATE_ERROR, updateError};
}

function updateLoading(updateLoading) {
  return {type: CAR_UPDATE_UPDATE_LOADING, updateLoading};
}

function updateSuccess(updated) {
  return {type: CAR_UPDATE_UPDATE_SUCCESS, updated};
}

function violations(violations) {
  return {type: CAR_UPDATE_UPDATE_VIOLATIONS, violations};
}

function reset() {
  return {type: CAR_UPDATE_RESET};
}
...
const mutations = {
    [CAR_UPDATE_RETRIEVE_ERROR] (state, payload) {
      state.retrieveError = payload.retrieveError;
    },
    [CAR_UPDATE_RETRIEVE_LOADING] (state, payload) {
      state.retrieveLoading = payload.retrieveLoading;
    },
    [CAR_UPDATE_RETRIEVE_SUCCESS] (state, payload) {
      state.retrieved = payload.retrieved;
    },
    [CAR_UPDATE_UPDATE_LOADING] (state, payload) {
      state.updateLoading = payload.updateLoading;
    },
    [CAR_UPDATE_UPDATE_ERROR] (state, payload) {
      state.updateError = payload.updateError;
    },
    [CAR_UPDATE_UPDATE_SUCCESS] (state, payload) {
      state.updated = payload.updated;
      state.violations = null;
    },
    [CAR_UPDATE_UPDATE_VIOLATIONS] (state, payload) {
      state.violations = payload.violations;
    },
    [CAR_UPDATE_RESET] (state) {
      state.loading = false;
      state.retrieveError = '';
